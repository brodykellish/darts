...
class CombinedRotationTranslationLoss(nn.Module):
    ...
    For rotation, this loss focuses only on the 3D directional component,
    ignoring rotation around the axis.
    """
    def __init__(self, rotation_mode='quaternion', rotation_weight=1.0, translation_weight=0.1,
        ...
        Args:
            ...
            reference_vector (list, optional): Reference vector to use for directional loss.
        ...
        self.reference_vector = reference_vector  # Will be used in future enhancements
